...
// interface Pedido {
//   id: number;
//   // CORRIGIDO: 'quantidade' e 'preco' vêm como string da API
//   quantidade: string; 
//   status: string;
//   usuario: {
//     nome: string;
...
//         // CORRIGIDO: Se a resposta não for 'ok', lê e exibe o erro da API
//         if (!response.ok) {
//           const errorData = await response.json();
//           console.error("Erro retornado pela API:", errorData);
//           throw new Error(errorData.erro || "Falha ao buscar os pedidos.");
//         }

//         const data = await response.json();
//         setPedidos(data);
//       } catch (error) {
//         // Agora o console.error vai mostrar o erro específico da API
//         console.error(error);
//         toast.error((error as Error).message || "Não foi possível carregar os pedidos.");
//       } finally {
//         setLoading(false);
//       }
//     }
...
//                     </td>
//                     <td className="px-6 py-4">
//                       {/* CORRIGIDO: Converte a quantidade para número antes de exibir */}
